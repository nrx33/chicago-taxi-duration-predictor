...
##### Note: All `cd` terminal commands assume you are in the project root directory. To access the MLflow UI, visit http://localhost:3000/ in your web browser after the Docker Compose applications are running. 
